...
WebUI.setText(findTestObject('Object Repository/Day-3/Data_Driven_Testing/Saucedemo_Login/Page_Swag Labs/input_Swag Labs_user-name'), 
    Username)

WebUI.click(findTestObject('Object Repository/Day-3/Data_Driven_Testing/Saucedemo_Login/Page_Swag Labs/div_Password for all userssecret_sauce'))

WebUI.setText(findTestObject('Object Repository/Day-3/Data_Driven_Testing/Saucedemo_Login/Page_Swag Labs/input_Swag Labs_password'), 
    Password)
